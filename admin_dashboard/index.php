    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="container-fluid">
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                ...
                //     header("location:adminprofilecopy.php");
                ...
                //    $data=$conn->query($sql);
                   if ($_SERVER["REQUEST_METHOD"] === "POST"){
                    $input_email=$_POST["user_email_Login"];
                    $input_pass=$_POST["user_password_Login"];
                    $sql = "SELECT * FROM users WHERE email='$input_email' AND password='$input_pass' AND is_admin=1";
                    $data=$conn->query($sql);
                    $ele=$data -> fetch_array(MYSQLI_ASSOC);
                    // print_r($ele);
